...
class AdminProductsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.products.index', compact('areas', 'products','brands','categories','states'));
    ...
    public function create()
    {
        ...
        return view('admin.products.create',compact('brands','states','categories','areas'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.products.edit',compact('brands','states','categories','areas','product','subcategory'));
    }
